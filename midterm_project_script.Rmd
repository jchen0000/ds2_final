...
rf.pred <- predict(rf.fit, newdata = x2, type = "prob")[,2]
...
auc <- c(roc.glmn$auc[1], roc.gam$auc[1], roc.lda$auc[1], roc.nn$auc[1])

modelNames <- c("glmn","gam","lda","nn")

# fig 5
ggroc(list(roc.glmn, roc.gam, roc.lda, roc.nn), legacy.axes = TRUE) + 
